module.exports = {
	'create' : {
		...
		'block_box' : data => `blocking the box, complaint filed #bikenyc #visionzero #CyclistsWithCameras #nyc311 #${data.plate} #C1_1_${data.comp_no}`,
	...
	'update' : {
		...
		'paid_fine' : data => `plead guilty, paid fine #bikenyc #visionzero #CyclistsWithCameras #nyc311 #C1_1_${data.comp_no}`,
