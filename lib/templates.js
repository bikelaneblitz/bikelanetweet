module.exports = {
	...
	'update' : {
		...
		'hearing_tomorrow' : data => `hearing tomorrow #bikenyc #visionzero #CyclistsWithCameras #nyc311 #${data.plate} #C1_1_${data.comp_no}`,
		'paid_fine' : data => `plead guilty, paid fine  #bikenyc #visionzero #CyclistsWithCameras #nyc311 #${data.plate} #C1_1_${data.comp_no}`,
	}
};
